...
def build(xml, risk_xml):
    ...
    cards.insert(1, '''<article class="ai-news-card"><p class="ai-news-topic">AI Learning &amp; Readiness</p><p class="ai-news-meta">Free official learning resources · Self paced</p><h3>Learn ChatGPT,<br>Claude &amp; Gemini</h3><ul class="ai-learning-links"><li><a href="https://academy.openai.com/" target="_blank" rel="noopener noreferrer"><span><strong>ChatGPT</strong><small>OpenAI Academy · Courses &amp; tutorials</small></span><span aria-hidden="true">↗</span></a></li><li><a href="https://academy.claude.com/" target="_blank" rel="noopener noreferrer"><span><strong>Claude</strong><small>Claude Academy · Practical AI skills</small></span><span aria-hidden="true">↗</span></a></li><li><a href="https://support.google.com/gemini/answer/13275745?hl=en" target="_blank" rel="noopener noreferrer"><span><strong>Gemini</strong><small>Google’s guide · Getting started</small></span><span aria-hidden="true">↗</span></a></li></ul></article>''')
...
<p class="ai-news-disclosure">Learning resources: OpenAI, Anthropic &amp; Google · Selected Sep 16, 2026. Third party news and education, provided for information. Inclusion does not imply endorsement by Veriscope.</p>
</div></section>
<!-- AI NEWS END -->'''
